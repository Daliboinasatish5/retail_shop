    ...
    <>
      <style>{`
        ...
        .img-logo-text {
          ...
          font-size: 1.25rem; font-weight: 700; color: #34d399; letter-spacing: -0.02em;
        }
        .img-quote {
        ...
        .img-badge {
          ...
          font-size: 0.76rem; color: #34d399;
        }
        .img-quote-text {
          font-family: 'Playfair Display', serif;
          font-size: 1.35rem; font-weight: 600; font-style: italic;
          color: #e6f4ee; line-height: 1.4; margin-bottom: 1rem;
        }
        .img-stats { display: flex; gap: 2rem; }
        .img-stat-num {
          font-family: 'Playfair Display', serif;
          font-size: 1.5rem; font-weight: 700; color: #34d399; display: block;
        }
        ...
        .auth-form-panel {
          ...
          padding: 3rem 2.5rem; overflow-y: auto; position: relative;
        }
        ...
        .form-heading {
          ...
          color: #e6f4ee; letter-spacing: -0.03em; margin-bottom: 0.4rem;
        }
        .form-sub { font-size: 0.875rem; color: #4a7a5c; font-weight: 300; margin-bottom: 2rem; line-height: 1.5; }

        .auth-form { display: flex; flex-direction: column; gap: 1rem; }
        .field-group { display: flex; flex-direction: column; }
        .field-label {
          display: block; font-size: 0.7rem; font-weight: 500; color: #8fbb9e;
        ...
        .auth-input:focus {
          border-color: rgba(52,211,153,0.45); background: rgba(52,211,153,0.05);
        ...
        .auth-divider::before, .auth-divider::after {
          content: ''; flex: 1; height: 1px; background: rgba(52,211,153,0.1);
        }
        ...
        <div className="auth-image-panel">
          ...
          <div className="img-quote">
            <div className="img-badges">
              <span className="img-badge">✦ Role-Based Access</span>
              <span className="img-badge img-badge-hide">✦ Realtime Sync</span>
              <span className="img-badge img-badge-hide">✦ 500+ Businesses</span>
            </div>
            <p className="img-quote-text">"One platform for every link in the supply chain."</p>
            <div className="img-stats">
              <div><span className="img-stat-num">500+</span><span className="img-stat-label">Businesses</span></div>
              <div><span className="img-stat-num">99.9%</span><span className="img-stat-label">Uptime</span></div>
              <div><span className="img-stat-num">4 Roles</span><span className="img-stat-label">Supported</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="auth-form-panel">
          <div className="form-inner">
            ...
            <form className="auth-form" onSubmit={onSubmit}>
              ...
              <Link to="/signup" className="auth-btn-outline">Create Account</Link>
            </form>
          </div>
        </div>
      </div>
